...
public interface ErrorMessages {
	    ...
	    public static final String INVALID_IMAGE_URL = " Image url  invalid failed";
	    public static final String PASSWORD_NULL = "  Password null  invalid failed";
	    public static final String PASSWORD_INVALID_PATTERN = "  Password pattern  invalid failed";

	    public static final String INVALID_LOCATION = "  Invalid  location  invalid failed";

	    public static final String INVALID_LANGUAGE_NULL = "  Invalid  language  null invalid failed";
		public static final String INVALID_POST_DESCRIPTION_NULL = "description nul";
		public static final String INVALID_POST_TITLE_NULL = "POst title null";
		public static final String INVALID_POST_ID_NULL = "post id null";
		public static final Object INVALID_SERVICE_NULL = null;
		public static final String SHEDULE_NULL_INVALID = "sCHDULE NULL INVLIAD";
