...
public class ArtistDAO {
	...
	public static int getArtistByName(String artistName) throws DAOException, SQLException {
		int id = 0;
	...
	public static Artist getArtistById(String artistId) throws DAOException, SQLException {
		Artist artist = null;
		try (Connection connection = ConnectionUtil.getConnection()) {
