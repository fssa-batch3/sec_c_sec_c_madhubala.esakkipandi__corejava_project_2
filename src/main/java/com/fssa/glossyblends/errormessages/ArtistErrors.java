...
/**
 * This class contains a collection of error messages that are related to
 * various aspects of the application, such as artist-related errors. These
 * messages provide descriptive information about the errors that can occur
 * during the execution of the application. The class is designed to provide
 * constant error message strings that can be used throughout the application's
 * codebase.
 */
public class ArtistErrors {
	...
	/**
	 * Error message indicating that a phone number does not match the correct
	 * format.
	 */
	public static final String INVALID_PHONE_NUMBER_FORMAT = "Phone number does not match the correct format should have 10 didgits";

	/**
	 * Error message indicating that an email address does not match the correct
	 * format.
	 */
	public static final String INVALID_EMAIL_FORMAT = "Email does not match the correct format   should have one uppercase lowercase and @ length should between 9 to 25";
	 ...
	 */
	public static final String INVALID_PASSWORD_PATTERN = "Password pattern is invalid  lenght should minimum 8";
	...
	public static final String INVALID_USERNAME_PATTERN = "Username should have alphabets uppercase and lowercase ";
