...
public class BookingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String pincode = formObject.getString("pincode");
			String address = formObject.getString("address");
			String doorNumber = formObject.getString("doorNumber");
			String mobileNumber = formObject.getString("mobileNumber");
			String name_Of_booker = formObject.getString("name");
			String time = formObject.getString("time");
