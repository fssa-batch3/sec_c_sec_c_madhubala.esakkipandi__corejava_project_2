...
public class LocationValidator {
	...
	private static final List<String> allowedLocations = Arrays.asList("chennai", "tirunelveli", "coimbatore", "trichy",
			"madurai", "salem", "erode", "vellore", "tuticorin", "thoothukudi", "kanyakumari", "thanjavur",
			"kanchipuram", "thiruvallur", "tiruppur", "karur", "virudhunagar", "nagercoil", "ooty", "krishnagiri",
			"sivaganga", "cuddalore", "ranipet", "nellai", "dharmapuri", "namakkal", "sankarankovil", "rishivandiyam",
