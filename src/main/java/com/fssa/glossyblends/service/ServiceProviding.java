...
public class ServiceProviding {
	...
	// Add a new service
	public boolean addService(String  email,Service service) throws ServiceValueInvalidException, DAOException, SQLException {
	...
	public boolean updateService(Service service) throws ServiceValueInvalidException, DAOException {
		try {
			if (!ServiceValidations.validateService(service)) {
	...
	public List<Service> getServicesByArtistId(int artistId) throws DAOException {
		try {
	...
	public Service getServiceById(int serviceId, int artistId) throws DAOException {
		try {
