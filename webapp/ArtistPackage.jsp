	...
	<div class="artist_pack">
		...
		<div class="package_div" id="pack">
			...
			<div class="card">
				...
				<button class="edit" onclick="showEditDeleteForm(this)"
					...
					style="margin-left: 90px; margin-top: 30px;">
					<i class="fa-solid fa-pen-to-square" style="color: #d70f64;"></i>
				</button>
				...
				<a
					...
					<button class="delete-button"
						...
						<i class="fa-solid fa-trash" style="color: #d70f64;"></i>
					</button>
				</a>
