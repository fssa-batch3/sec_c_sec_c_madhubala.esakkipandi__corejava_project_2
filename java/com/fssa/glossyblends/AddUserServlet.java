...
import com.fssa.glossyblends.customexception.UserDetailsException;
...
public class AddUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("Success", "Successfully SignUp");

		} catch (ArtistDetailsExceptions | DAOException | SQLException | UserDetailsException e) {
