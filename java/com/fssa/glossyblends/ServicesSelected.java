 ...
 */
@WebServlet("/ServicesSelected")
public class ServicesSelected extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (SelectedService ser : service) {
				...
				System.out.print(addedservice.getCost());

				serviceAdd.add(addedservice);
				request.setAttribute("listOfService", serviceAdd);
				request.getRequestDispatcher("Showingselectedservice.jsp").forward(request, response);
